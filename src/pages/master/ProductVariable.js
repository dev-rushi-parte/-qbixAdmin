            ...
            <Row>
                <Col xl={12}>
                    <CardLayout>
                        <Breadcrumb title={data?.pageTitlevariable}>
                            {data?.breadcrumbEdit.map((item, index) => (
                ...
                <Col xl={12}>
                    <CardLayout>
                        ...
                        <Row>
                            <Col xl={6}><LabelField value={productData?.producttitle} onChange={handleChange} name='isvariable' label="isvariable" option={['0', '1']} fieldSize="w-100 h-md" /></Col>
