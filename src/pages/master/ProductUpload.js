...
export default function ProductUpload() {
    ...
    const [productData, setProductData] = useState({ "productstatus": "InActive", "isdiscount": "No" })
    ...
    const handelSubmit = () => {
        ...
        if (productData.productcategoryname && productData.productdescription && productData.productimage1 &&
