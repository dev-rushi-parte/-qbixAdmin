...
export default function ProductUpload() {
    ...
    const [productData, setProductData] = useState({ "productcategoryid": "", "productstatus": "InActive", "isdiscount": "No" })
    ...
    const handleChange = (e) => {
        ...
        if (name === 'productcategoryname') {
            ...
            let ans = categoryData?.find((item) => {
                return item.categorytitle == value
            })
            // console.log(ans)

            setProductData(prevState => ({
                ...prevState,
                productcategoryid: ans._id
            }));
        }
        setProductData(prevState => ({
            ...prevState,
                ...
                <Col xl={12}>
                    <CardLayout>
                        ...
                        <Row>
                            ...
                            <Col xl={6}><LabelField onChange={handleChange} name='productstatus' label="Product Status" option={['inActive', 'active']} fieldSize="w-100 h-md" /></Col>
                            <Col xl={6}><LabelField onChange={handleChange} name='productprice' type="text" label="Price" fieldSize="w-100 h-md" /></Col>
                            <Col xl={6}><LabelField onChange={handleChange} name='isdiscount' label="Discount" option={['no', 'yes']} fieldSize="w-100 h-md" /></Col>
                            {productData?.isdiscount === 'yes' ? <Col xl={6}><LabelField onChange={handleChange} name='discountprice' type="text" label="Discount Price" fieldSize="w-100 h-md" /></Col> : ""}
